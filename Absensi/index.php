...
<head>
    <meta charset="utf-8">
    <title>Absensi | Intan</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <script defer src="face-api.min.js"></script>
    <script defer src="scripttt.js"></script>
...
<body>
    ...
    <div class="container-fluid page-header py-5 mt-5">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Absensi Online</h1>
                ...
                <div class="row g-5 mb-5 justify-content-center">
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">2. Pastikan Wajah Anda di Depan Kamera</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">3. Tunggu Sampai Wajah Terdeteksi</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                        <div class="d-flex bg-light p-3 rounded">
                            ...
                            <div class="ms-3">
                                <h4 class="text-primary">4. Tekan Tombol Ambil Absen</h4>
                            </div>
                        </div>
                    </div>
                </div>
